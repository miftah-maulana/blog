...
![tmux command only](https://miftah-maulana.my.id/assets/images/TMUX/tmux command only part.png)

![tmux command only](https://miftah-maulana.my.id/assets/images/TMUX/tmux command only part 2.png)
